...
<head>
    ...
    <title>Register - Smart Scheduler & Financial Report</title>
            ...
            <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
                ...
                <div class="rounded-md shadow-sm -space-y-px">
                    ...
                    <div>
                        ...
                        <select id="role" name="role" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm">
                            <option value="influencer" {{ old('role') == 'influencer' ? 'selected' : '' }}>Influencer</option>
