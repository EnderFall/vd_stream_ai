                    ...
                    <form method="POST" action="{{ route('financial.index') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="category" name="category" required
                                ...
                                <optgroup label="Income">
                                    ...
                                    <option value="donation" {{ old('category') == 'donation' ? 'selected' : '' }}>Donation</option>
                                    <option value="ads" {{ old('category') == 'ads' ? 'selected' : '' }}>Ads/Revenue</option>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                      class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                        </div>
